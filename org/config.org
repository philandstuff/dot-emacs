...
From [[https://gist.github.com/jupp0r/08ca64b7c14c6093bba2][this gist]], a way to access gpg-agent from =~/.gpg-agent-info=
rather than from environment variables (which may be subverted by
gnome-keychain or OS X keychain instead of a true gpg agent).
